...
{	
	...
	{	
		...
		protected static const SBGNML:String    = "sbgn";
		 ...
		 */
		public function parse(sbgnML:XML, genomicData:*=null):DataSet 
		{	
			sbgnml = sbgnML;
			...
			for each (var glyph:XML in glyphs) 
			{
				...
				cns.data = parseGlyphData(glyph,glyphSchema, genomicData);						
		...
		public function parseGlyphData(glyph:XML, schema:DataSchema, genomicData:* = null):Object 
		{
			var n:Object = {};
