...
//        }
    ...
    private int[] sampleCountArrayAlongProtein(Set<Hotspot> hotspotsOnAProtein, int window) {
        int lenProtein = hotspotsOnAProtein.iterator().next().getProtein().getProteinLength();
